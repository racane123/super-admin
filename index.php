...
<body>
    ...
    <nav class="navigation-bar">
        <div class="logo">
            ...
            <h3 class="logo-text">TownTech Innovations</h3>
        </div>
        <ul class="nav-menu">
            <li>
                <a href="/home">Home</a>
    ...
    <div class="layer1">
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Delectus eos impedit et possimus quibusdam cumque quos natus, corrupti veniam doloribus?</p>
